...
> ใช้คู่กับเอกสาร `Firebase\_Studio\_AI\_Prompts.md` (Prompt Pack 14 โมดูล)
...
เมื่อครบ checklist แล้ว ให้เปิดไฟล์ `Firebase\_Studio\_AI\_Prompts.md` แล้วเริ่มจาก **Module 0** ได้เลย
